...
const StilltrueFlow = () => (
  ...
  >
    ...
    {/* The judge, outside the boundary.
        ...
        Copy split onto more lines 2026-09-13: the old two-line body overran
        the box, and the picker list had to name Gemini, OpenAI, and RabinAI. */}
    <rect x="196" y="608" width="368" height="104" fill="none" stroke="var(--color-accent)" strokeWidth="2" />
    <text x="380" y="628" fontSize="13" fontWeight="700" textAnchor="middle" fill="var(--color-accent)">the judge · temperature 0</text>
    <text x="380" y="648" fontSize="11" textAnchor="middle" fill="currentColor">lives in your app (bfoster-services)</text>
    <text x="380" y="664" fontSize="11" textAnchor="middle" fill="currentColor">the only AI in the system</text>
    <text x="380" y="684" fontSize="11" textAnchor="middle" fill="var(--color-neutral-600)">this page lets you pick Gemini, OpenAI,</text>
    <text x="380" y="700" fontSize="11" textAnchor="middle" fill="var(--color-neutral-600)">or RabinAI on Brian's mini PC</text>
